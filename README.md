...
In addition a check is done for inputs with both the mouse( for camera direction) and WASD (for movement) being checked. This allows the user to move around the scene
